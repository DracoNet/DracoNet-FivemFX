...
local lang = {
  common = {
    welcome = "Witaj na serwerze. Nacisnij F9 aby wlaczyc menu. Server aktualnie jest dopracowywany pod wzgledem spolszczenia jak i technicznym. Dolacz do nas na Discord https://discord.gg/7FzYYwK.~n~",
