...
currentWeatherString = "DRAGON"   -- Starting Weather Type.
...
weatherTree = {
	...
	["CLOUDS"] = {"CLEAR","SMOG","FOGGY","CLEARING","OVERCAST","SNOW","SNOW"},
	["FOGGY"] = {"CLEAR","CLOUDS","SMOG","OVERCAST"},
	["OVERCAST"] = {"CLEAR","CLOUDS","SMOG","FOGGY","RAIN","CLEARING"},
	["RAIN"] = {"THUNDER","CLEARING","SNOW","SNOW","OVERCAST"},
	["THUNDER"] = {"RAIN","CLEARING","BLIZZARD"},
	["CLEARING"] = {"CLEAR","CLOUDS","OVERCAST","FOGGY","SMOG","RAIN"},
	["SNOW"] = {"BLIZZARD","RAIN","SNOW"},
	["BLIZZARD"] = {"SNOW","SNOW","THUNDER"},
	["SNOWLIGHT"] = {"SNOW","RAIN","CLEARING"},
	["DRAGON"] = {"EXTRASUNNY","CLOUDS","RAIN","THUNDER","FOGGY","CLEARING","OVERCAST","CLEAR"}
}
